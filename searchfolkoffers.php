...
" name="searchit" id="searchit" placeholder="search for ..." autocomplete="off" onkeyup="callfunc(this.value)"  />
    ...
    <div class="col-lg-5 col-xs-4 col-sm-5 col-md-5 topmenus3 wdtset" style="cursor:pointer;border-right: 1px solid #e3e1e1;" onclick="location.href='searchfolk.php'" >what folks want</div>
     
     <div class="col-lg-6 col-xs-6 col-sm-6 col-md-6 topmenusselected3" style="cursor:pointer;" onclick="location.href='searchfolkoffers.php'">what folks are offering</div>
...
/*and  (search_type='make' or search_type='get')*/
         ...
         $arrayget = $obj->selectAll('user_saved_searches','*',"  userid='".$_SESSION['user_session']."' and search_type='folksoffers' ",'order by save_id DESC');
