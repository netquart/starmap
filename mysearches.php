...
<!--    <script type="text/javascript" src="fg.menu2.js"></script>
-->    
    <!-- required styles -->
...

{
	...
	
	{
	  ...
	  // category = category.replace('<span class="glyphicon glyphicon-chevron-down" style="color:#333333;">','');
  ...
  <div class="col-lg-12 col-md-12 custom_padding"><?php include("left_nav.php"); ?>
   ...
   <div class="col-lg-8 col-sm-12 col-xs-12 col-md-12 paddingset">
    ...
    <div class="col-lg-12 showthis" style="color:#7e7e7e; font-family:Tahoma, Geneva, sans-serif; font-size:14px;margin-top:20px; margin-bottom:12px;">
     ...
     <div class="col-lg-4 col-xs-4 col-sm-4 col-md-4 topmenus" id="whatfolkswant" onclick="location.href='search-stuff.php'">search for stuff</div><!--stuff i'm looking for-->
     
           <div class="col-lg-4 col-xs-4 col-sm-4 col-md-4 topmenusselected" onclick="location.href='mysearches.php'">my searches</div>

     
     <div class="col-lg-4 col-xs-4 col-sm-4 col-md-4 topmenus" id="folksoffers"></div>
      ...
      <?php
         ...
         $arrayget = $obj->selectAll('user_saved_searches','*',"  userid='".$_SESSION['user_session']."' and  search_type='get' ",'order by save_id DESC');
	  ...
	  ?>
         ...
         ?>    
          ...
          <div class="col-lg-7 col-xs-12 col-sm-9 col-md-7 " style="padding:0px;">

               <div style="float:left;  padding-right:0px;" class="col-xs-12 col-sm-12 col-md-12 col-lg-12 paddingleftset">

           <div style="float:left;font-family:Arial, Helvetica, sans-serif; font-size:16px;color:#999999; font-weight:normal;" id="title_<?php echo $array['save_id']; ?>">
	  ...
	  echo '<p id="kywordss_'.$array['save_id'].'">'.$array['keywords'].'</p>';
	  ...
	  
	  {
		...
		echo '<p id="ammt_'.$array['save_id'].'">$'.str_replace('$','',$array['amount']).'</p>';
	  ...
	  echo '<p id="ammt_'.$array['save_id'].'"></p>';
    ...
    <div class="modal-content">
      ...
      <div class="modal-body">
        <div style="margin-top:15px;"> <div class="form-group"><input class="form-control" type="text" name="keyword" id="keyword_<?php echo $array['save_id'] ?>" value="<?php echo $array['keywords']; ?>" size="7"> </div></div>
         ...
         <div style="margin-top:15px;" class="col-lg-12 col-sm-12">
         
         <div class="col-lg-4 col-sm-4" style="float:left;">I will pay between $ </div> 
        
        <div class="col-lg-2 col-sm-2" style="float:left;">
        <div class="form-group"><input type="text" class="form-control" name="amount1" id="amount1_<?php echo $array['save_id'] ?>" value="<?php echo str_replace('$','',$array['amount']); ?>" size="7"></div>
        </div>
        
        
         
         <div class="col-lg-3 col-sm-3" style="float:left;">- $ </div>
         <div class="col-lg-2 col-sm-2" style="padding:0px; float:left"><div class="form-group"><input type="text" class="form-control"  name="amount2" id="amount2_<?php echo $array['save_id'] ?>" value="<?php echo str_replace('$','',$array['amount']); ?>" size="7"></div>
 ...
 <ul>
     ...
     <li>
      ...
      <a href="46">rent something</a>
        ...
        <div class="col-lg-5 col-xs-12 col-sm-5 col-md-5" style=" text-align:right; padding:0px;">
