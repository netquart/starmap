	...
	function loadlastreply2(id,bidid)
{
	...
	function updatetotal(id,keywords,price,cat,type)

{
	...
	$("#folwant").css('background','none');
	
	$("#folwant").css('color','#000');
	
	$("#foloffr").css('background','#d32028');
	
	$("#foloffr").css('color','#fff');	
		
	}
	
	else if(type=='whatfolkswant')
	...
	$("#foloffr").css('background','none');
	
	$("#foloffr").css('color','#000');
	
	$("#folwant").css('background','#d32028');
	
	$("#folwant").css('color','#fff');	
		
	}
	
	
	else if(type=='whathappen')
 ...
 <div class="container custombg">
  ...
  <div class="col-lg-12 col-md-12 custom_padding"><?php include("left_nav.php"); ?>
    ...
    <div class="col-lg-8 col-sm-12 col-xs-12 col-md-12 paddingset">
      ...
      <div class="boxes2" id="filter">
      
      <div id="all" class="col-lg-1 col-xs-2 col-sm-1 col-md-1 topmenusselected3 wdtset2" onclick="location.href='mysearches2.php'" style="cursor:pointer;border-right: 1px solid #e3e1e1;" >all</div>
     
    <div id="folwant" class="col-lg-5 col-xs-4 col-sm-5 col-md-5 topmenus3 wdtset" style="cursor:pointer;border-right: 1px solid #e3e1e1;" onclick="location.href='searchfolk.php'" >what folks want</div>
     
     <div id="foloffr" class="col-lg-6 col-xs-6 col-sm-6 col-md-6 topmenus3" style="cursor:pointer;" onclick="location.href='searchfolkoffers.php'">what folks are offering</div>
...
/*and  (search_type='make' or search_type='get')*/
         ...
         $arrayget = $obj->selectAll('user_saved_searches','*',"  userid='".$_SESSION['user_session']."'  ",'order by save_id DESC');
...
$countg=0; 
         ...
         ?>    
          ...
          <div class="col-lg-4 col-xs-4 col-sm-4 col-md-4 " style="padding:0px;">

               <div style="float:left;  padding-right:0px; padding-left:0px;" class="col-xs-12 col-sm-12 col-md-12 col-lg-12 paddingleftset">
	  ...
	  echo '<p style="font-size:12px;" id="ctg_'.$array['save_id'].'">'.$showtype.'</p>';
 ...
 <ul>
     ...
     <li>
      ...
      <div class="modal-footer">
        ...
        <div class="col-lg-8 col-xs-8 col-sm-8 col-md-8" style=" text-align:right; padding:0px;">
        
        
        <div class="col-lg-12 col-xs-12 col-sm-12 col-md-12" style="display:inline-block; margin-top:47px; padding-right:0px;">
 <?php
       
	   			$obj->viewbutton002($array['save_id'],$array['total_results'],$array['keywords'],$amt,$array['category'],$array['search_type']);
   ...
   <!--body navigation ends-->
	...
	$dynamic2 +=1;	
	  ...
	  echo '<div style="float:none;color:#333; padding:25px 10px 10px 5px;text-align:center;clear:both;">you haven\'t saved any searches yet</div>';
